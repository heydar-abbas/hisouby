...
<script setup lang="ts">
	...
	function check(): void {
		if (operator.value === "<") {
			quiz.value.q3 = 1;
			$quizStore.setPopup("احسنت", true, "/grade/_3rd/unit1/quiz5/q4");
		} else {
			quiz.value.q3 = -1;
	...
	function handelSkip(): void {
		...
		$quizStore.setSkipPopup("/grade/_3rd/unit1/quiz5/q4");
	}
