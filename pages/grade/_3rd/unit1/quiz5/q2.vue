...
<script setup lang="ts">
	...
	function check(): void {
		if (operator.value === "<") {
			quiz.value.q2 = 1;
			$quizStore.setPopup("احسنت", true, "/grade/_3rd/unit1/quiz5/q3");
		} else {
			quiz.value.q2 = -1;
	...
	function handelSkip(): void {
		...
		$quizStore.setSkipPopup("/grade/_3rd/unit1/quiz5/q3");
	}
