...
<script setup lang="ts">
	...
	function check(): void {
		if (checkResults() || checkArResults()) {
			quiz.value.q4 = 1;
			$quizStore.setPopup("احسنت", true, "/grade/_3rd/unit1/quiz4/q5");
		} else {
			quiz.value.q4 = 0;
	...
	function handelSkip(): void {
		...
		$quizStore.setSkipPopup("/grade/_3rd/unit1/quiz4/q5");
	}
