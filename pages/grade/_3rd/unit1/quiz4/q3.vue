			...
			<div class="grid sm:grid-cols-3 gap-4 sm:w-lg mx-auto">
				<div class="col-span-2 flex items-center justify-center sm:p-4">
					<p class="text-sm md:text-base font-semibold">
						سبعة الاف وتسعمئة وثمانية وعشرون
					</p>
				</div>
...
<script setup lang="ts">
	...
	function check(): void {
		if (checkResults() || checkArResults()) {
			quiz.value.q3 = 1;
			$quizStore.setPopup("احسنت", true, "/grade/_3rd/unit1/quiz4/q4");
		} else {
			quiz.value.q3 = 0;
	...
	function handelSkip(): void {
		...
		$quizStore.setSkipPopup("/grade/_3rd/unit1/quiz4/q4");
	}
