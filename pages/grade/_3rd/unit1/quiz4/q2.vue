			...
			<div class="grid sm:grid-cols-3 gap-4 sm:w-lg mx-auto">
				<div class="col-span-2 flex items-center justify-center sm:p-4">
					<p class="text-sm md:text-base font-semibold">
						ثمانية الاف وسبعمئة واثنان وخمسون
					</p>
				</div>
...
<script setup lang="ts">
	...
	function check(): void {
		if (checkResults() || checkArResults()) {
			quiz.value.q2 = 1;
			$quizStore.setPopup("احسنت", true, "/grade/_3rd/unit1/quiz4/q3");
		} else {
			quiz.value.q2 = -1;
	...
	function handelSkip(): void {
		...
		$quizStore.setSkipPopup("/grade/_3rd/unit1/quiz4/q3");
	}
