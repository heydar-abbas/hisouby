...
<script setup lang="ts">
	...
	function check(): void {
		if (answer.value === "1700" || answer.value === "١٧٠٠") {
			quiz.value.q6 = 1;
			$quizStore.setPopup("احسنت", true, "/grade/_3rd/unit1/quiz7/q7");
		} else {
			quiz.value.q6 = -1;
	...
	function handelSkip(): void {
		...
		$quizStore.setSkipPopup("/grade/_3rd/unit1/quiz7/q7");
	}
