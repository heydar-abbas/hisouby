...
<script setup lang="ts">
	...
	function check(): void {
		if (answer.value === "400" || answer.value === "٤٠٠") {
			quiz.value.q4 = 1;
			$quizStore.setPopup("احسنت", true, "/grade/_3rd/unit1/quiz7/q5");
		} else {
			quiz.value.q4 = -1;
	...
	function handelSkip(): void {
		...
		$quizStore.setSkipPopup("/grade/_3rd/unit1/quiz7/q5");
	}
