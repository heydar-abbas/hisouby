...
<script setup lang="ts">
	...
	function check(): void {
		if (answer.value === "5460" || answer.value === "٥٤٦٠") {
			quiz.value.q2 = 1;
			$quizStore.setPopup("احسنت", true, "/grade/_3rd/unit1/quiz7/q3");
		} else {
			quiz.value.q2 = -1;
	...
	function handelSkip(): void {
		...
		$quizStore.setSkipPopup("/grade/_3rd/unit1/quiz7/q3");
	}
