<template>
	<QuizArticle>
		...
		<!-- Question Content -->
		<QuizQuestionContent question="أقرب الأعداد الى أقرب مئة:">
			<div class="sm:w-lg mx-auto">
				<div class="flex gap-4 w-full justify-center items-center">
					<div class="text-2xl">٥٧٦٧</div>
...
<script setup lang="ts">
	...
	function check(): void {
		if (answer.value === "5800" || answer.value === "٥٨٠٠") {
			quiz.value.q5 = 1;
			$quizStore.setPopup("احسنت", true, "/grade/_3rd/unit1/quiz7/q6");
		} else {
			quiz.value.q5 = -1;
	...
	function handelSkip(): void {
		...
		$quizStore.setSkipPopup("/grade/_3rd/unit1/quiz7/q6");
	}
